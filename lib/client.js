 ...
 *  - `devices`, (optional) array of devices, {hwid,id,name}
 */
...
Client.prototype.set = function set(id) {
  var id=id.toString();
  if (this.devices.hasOwnProperty(id)) {
    return this.devices[id].set(this._sendMessage)
  } else {
...
Client.prototype._onConnect = function _onConnect() {
  ...
  for (key in this.listening) {
    this._susbcribe(this.listening[key])
  }
};
 ...
 * @method _sendMessage
 */
Client.prototype._sendMessage = function _sendMessage(topic, payload) {
